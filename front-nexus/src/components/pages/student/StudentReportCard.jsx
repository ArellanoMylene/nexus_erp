    ...
    <div className=" p-3 sm:p-4 transition-colors duration-500">
      <div className="w-full max-w-7xl mx-auto space-y-4 font-sans">
            ...
            <div>
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold text-slate-900 ">{reportCard?.year_level || "3rd Year"}</span>
                </div>
              </div>
            </div>
            <div>
              <h3 className="text-lg font-bold text-slate-900  mb-3">Academic Summary</h3>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-bold text-lg text-indigo-600 ">{reportCard?.gpa || "3.75"}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-600 ">Total Units:</span>
                  <span className="font-semibold text-slate-900 ">{reportCard?.total_units || "21"}</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white  rounded-lg border border-slate-200  p-4">
          <h3 className="text-lg font-bold text-slate-900  mb-4">Grades This Semester</h3>
            ...
            <table className="min-w-full divide-y divide-slate-200 ">
              ...
              <tbody className="divide-y divide-slate-100 ">
                {(reportCard?.grades || [
                  ...
                  <tr key={index} className="text-sm text-slate-700  hover:bg-indigo-50/50 ">
