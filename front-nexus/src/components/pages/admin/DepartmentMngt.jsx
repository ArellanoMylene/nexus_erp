...
const ActionButton = ({ onClick, icon, label, className, tooltipText }) => {
  ...
  return (
    <div className="relative inline-block">
      ...
      {showTooltip && (
        <div className="absolute z-50 bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-1 bg-slate-800 text-white text-xs rounded-lg shadow-xl pointer-events-none   before:content-[''] before:absolute before:top-full before:left-1/2 before:-translate-x-1/2 before:border-8 before:border-transparent before:border-t-slate-800 ">
          {tooltipText}
        </div>
      )}
    </div>
...
const CrudModal = ({
  ...
  return (
    ...
    >
      <div
        className="bg-white  rounded-lg shadow-2xl w-full max-w-sm sm:max-w-md transform transition-transform duration-300 scale-100 border border-slate-200 "
    ...
    <div className="flex flex-wrap items-center justify-between gap-3">
      ...
      <div className="relative flex-grow max-w-xs">
        <input
          ...
          className={`w-full pl-8 pr-3 py-2 rounded-md border border-slate-300  focus:outline-none focus:ring-2 ${primaryRing}   text-sm transition-all shadow-inner`}
        />
        <Search
      ...
      <div className="flex items-center gap-2">
        ...
        <ActionButton
          ...
          className="bg-indigo-600 text-white hover:bg-indigo-700 border-indigo-700  shadow-md shadow-indigo-500/30"
        />
      </div>
    </div>
...
const PrerequisiteManager = ({
  ...
  return (
    <div className="space-y-4">
      {/* Setup Form */}
      <div className="p-4 border border-slate-300  rounded-lg bg-slate-50  shadow-md">
        <h4 className="text-base font-bold text-slate-900  mb-3 flex items-center gap-2 border-b border-slate-200  pb-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 items-end">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 text-sm border border-slate-300  rounded-md   disabled:bg-slate-100  disabled:cursor-not-allowed focus:ring-indigo-500 focus:border-indigo-500"
            >
          ...
          <ActionButton
            ...
            className="bg-indigo-600 text-white hover:bg-indigo-700 h-full border-indigo-700 "
          />
        </div>
      </div>

      {/* Existing Prerequisites List */}
      <h4 className="text-lg font-bold text-slate-900  mt-4 flex items-center gap-2">
        <LayoutGrid size={20} className="text-indigo-600" /> Existing
        Dependencies
      </h4>

      <div className="overflow-x-auto rounded-lg border border-slate-200  shadow-xl">
        <table className="min-w-full divide-y divide-slate-200 ">
          <thead className="bg-slate-100 ">
            <tr className="text-left text-xs font-bold uppercase tracking-wider text-slate-700 ">
            ...
            {prerequisites.length > 0 ? (
              prerequisites.map((p, index) => (
                ...
                >
                  ...
                  <td className="px-4 py-2 italic text-indigo-600 ">
          ...
          {[
            ...
            <button
              ...
              className={`
                ...
                ${
                  activeTab === key
                    ? "border-indigo-600 text-indigo-600  bg-white  shadow-t-sm"
